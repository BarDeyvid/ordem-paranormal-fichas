...
content = content.replace(/<div className="my-5 flex min-h-\[102px\] items-center justify-center rounded-lg border border-zinc-800 bg-zinc-950\/80 p-4">\s*<p className="text-sm font-bold text-green-500">Perícias em dobro<\/p>\s*<\/div>/g, 
...
content = content.replace(/<div className="my-5 flex min-h-\[102px\] items-center justify-center rounded-lg border border-zinc-800 bg-zinc-950\/80 p-4">\s*<p className="text-sm font-bold text-green-500">Vontade & Ocultismo<\/p>\s*<\/div>/g, 
