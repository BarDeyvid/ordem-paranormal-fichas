...
function convertTabs(file) {
  ...
  // Find the Element filter container block in ModalRituais / ModalRituaisExtra
  // Usually starts with <div className="flex flex-wrap border-b border-zinc-800 bg-zinc-950 px-4 pt-3">
  
  const regex = /<div className="flex flex-wrap border-b border-zinc-800 bg-zinc-950 px-4 pt-3">[\s\S]*?<\/div>/;
  ...
  const newBlock = `<div className="flex flex-wrap items-center gap-2 border-b border-zinc-800 bg-zinc-900/90 px-4 py-3">
